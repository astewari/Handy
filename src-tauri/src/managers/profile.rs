...
pub fn get_built_in_profiles() -> Vec<Profile> {
    vec![
        ...
        Profile {
            ...
            system_prompt: "You are a technical instruction optimizer. Convert natural speech into clear, structured instructions for AI agents. Use imperative voice, be specific and unambiguous, and remove conversational elements. Output ONLY the instruction with no preamble, explanations, or meta-commentary.".to_string(),
            user_prompt_template: "Convert this speech into a clear instruction for an AI agent. Output ONLY the result:\n\n{transcription}".to_string(),
            is_built_in: true,
            created_at: None,
            updated_at: None,
        ...
        Profile {
            ...
            system_prompt: "You are an email writing assistant. Convert speech into a well-formatted email. Add appropriate greeting and closing if missing, use proper paragraphs, and maintain professional yet friendly tone. Output ONLY the email text with no preamble, explanations, or meta-commentary.".to_string(),
            user_prompt_template: "Convert this speech into a well-formatted email. Output ONLY the email:\n\n{transcription}".to_string(),
            is_built_in: true,
            created_at: None,
            updated_at: None,
        ...
        Profile {
            ...
            system_prompt: "You are a note-taking assistant. Convert speech into concise, well-organized notes using bullet points. Extract key information and organize logically. Output ONLY the notes with no preamble, explanations, or meta-commentary.".to_string(),
            user_prompt_template: "Convert this speech into organized notes. Output ONLY the notes:\n\n{transcription}".to_string(),
            is_built_in: true,
            created_at: None,
            updated_at: None,
            timeout_seconds: Some(10),
        ...
        Profile {
            ...
            system_prompt: "You are a technical documentation assistant. Convert speech into clear, concise code comments or documentation. Use technical language appropriately and be precise. Output ONLY the documentation with no preamble, explanations, or meta-commentary.".to_string(),
            user_prompt_template: "Convert this speech into a code comment or technical documentation. Output ONLY the result:\n\n{transcription}".to_string(),
            is_built_in: true,
            created_at: None,
            updated_at: None,
            timeout_seconds: Some(10),
